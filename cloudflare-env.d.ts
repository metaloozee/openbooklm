/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: baf6155b31af9518244cd402dfb088f2)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		DB: D1Database;
		ASSETS: Fetcher;
		NEXT_PUBLIC_BETTER_AUTH_URL: "https://document-rag-cf.metaloozee.workers.dev/";
		NEXTJS_ENV: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_BETTER_AUTH_URL" | "NEXTJS_ENV">> {}
}
