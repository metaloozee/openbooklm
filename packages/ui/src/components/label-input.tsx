...
export function LabelInput({
	...
	return (
		<div className={cn("group relative w-full", className, containerClassName)}>
			<input
				className={cn(
					"block outline-none peer text-primary w-full px-2 py-0.5 h-7 text-sm rounded-lg border focus:ring-2 dark:bg-neutral-950 dark:border-neutral-700/75 autofill:shadow-[inset_0_0_0px_1000px_var(--color-background)]",
					isPasswordType && "pr-9",
